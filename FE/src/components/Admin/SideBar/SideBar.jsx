  ...
  return (
    <div id="SideBar">
      ...
      <ul className="sidebar-menu">
        ...
        <li
          className={`menu-item ${activeItem === "manage" ? "active" : ""}`}
          onClick={dropdownManagemnet}
        >
        ...
        <div className={`dropdown ${activeItem === "manage" ? "active" : ""}`}>
          <div
            className={`menu-item ${
              location.pathname === "/admin/instructor" ? "active" : ""
            }`}
          >
        ...
        <li
          className={`menu-item ${
            location.pathname === "/admin/course" ? "active" : ""
          }`}
        >
        ...
        <li
          className={`menu-item ${
            location.pathname === "/admin/report" ? "active" : ""
          }`}
        >

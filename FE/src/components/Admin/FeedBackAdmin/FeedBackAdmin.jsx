...
const initialStudents = [
  {
    ...
    name: "Bap",
    title: "Cheap and easy to understand course",
    status: "Active",
    img: IntructorIMG,
    phone: "0353747221",
    ...
    activities: [
      ...
      {
        name: "Received email about Active course recommendations",
  ...
  },
  {
    ...
    name: "Oscar Witting",
    status: "Active",
    title: "The course so easy to learn",
    img: IntructorIMG2,
    phone: "0353747223",
    ...
    setStudents((prevStudents) =>
      prevStudents.map((student) =>
        student.id === id
          ? {
              ...student,
              status: student.status === "Active" ? "Block" : "Active",
            }
          : student
      )
    );
          ...
          <div className="popup-container">
            <div className="popup-info">
              <div className="popup-info-image">
                <img
                  src={initialStudents[currentNum].img}
                  alt={initialStudents[currentNum].name}
                />
              </div>

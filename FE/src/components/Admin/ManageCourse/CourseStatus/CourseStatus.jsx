...
const DataTableActiveCancel = ({ data }) => {
     const pageSize = 10;
     ...
     const activeCancelCourses = filteredCourses.filter(course => course.status === "Active" || course.status === "Cancel");
     const currentCourses = activeCancelCourses.slice(indexOfFirstCourse, indexOfLastCourse);
     const totalPages = Math.ceil(activeCancelCourses.length / pageSize);
...
export default DataTableActiveCancel;

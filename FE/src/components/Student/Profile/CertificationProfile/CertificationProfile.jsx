                              ...
                              <div key={index} className="credential-item" id={`credential-item-${index}`} style={(index < itemShow) ? {} : { display: 'none' }}>
                                   <div className="certification-header">
                                        <div className="certification-image">
                                             <img src={cert.certification.course.images[0].url} alt={cert.certification.course.name} />
                                        </div>
                                        <div className="certification-details">
                                             <h3 id={`credential-title-${index}`}>{cert.certification.course.name}</h3>
                                             <p className={`field-tag`}>{cert.certification.course.cateCoruse[0].category.names[0]}</p>

...
export default function PersonalDetail() {
  ...
  useEffect(() => {
    document.body.style.overflow =
      isOpenVisible || isOpenEdit || isOpenAddInfo ? "hidden" : "auto";
  }, [isOpenVisible, isOpenEdit, isOpenAddInfo]);
  ...
  useEffect(() => {
    const avatars = document.querySelectorAll(
      "#personal-detail .row-avatar img",
    );
    let currentIndex = 0;
  ...
  return (
    <div id="personal-detail">
      <div className="personal-detail-container-row1">
        <div className="personal-detail-container-column">
          <div className="row-edit">
            ...
            <div
              ...
              style={isOpenEdit ? { display: "block" } : { display: "none" }}
            >
              <div className="popup-edit-container">
                <div
                  className="popup-edit-buttonclose"
                  onClick={() => {
                    setIsOpenEdit(false);
                  }}
                  title="Close Popup"
                ...
                <div className="popup-row">
                  ...
                  <div className="popup2-row-text">
                    <p>
                      Add your personal details as you would like it to appear
                      on your profile.
                    </p>
                  </div>
                  ...
                  <div
                    className="popup2-row-title"
                    title="Your fist name and last name"
                  >
          ...
          <div className="row-username">
            <h10>{user.username === null ? user.email : user.username}</h10>
          </div>
          ...
          <div className="row-update">
            <div className="row-update-container">
              ...
              <div
                className="popup-visible-profile"
                style={
              ...
              >
                <div className="popup-visible-profile-buttonclose-container">
                  <div
                    className="popup-visible-profile-buttonclose"
                    onClick={() => {
                ...
                <div className="popup-row">
                  ...
                  <div className="popup-row-text">
                    <p>
                      Sharing your profile is a great way to stand out by
                      showcasing your skills and accomplishments on CodeCourse.
                    </p>
                  </div>
                  ...
                  <div className="popup-row-text2">
                    ...
                    <div className="popup-row-text2-container">
                      <div>
                        <input
                          className="popup-row-text2-button"
                          type="checkbox"
                          id="public1"
                          value="public"
                        />
                    ...
                    <p
                      className="popup-row-text3"
                      style={{ marginTop: "10px", fontWeight: "100" }}
                    >
                      Anyone who has the link to your profile can view it (but
                      it won’t appear as a result on search engines).
                    </p>
                  </div>

                  <div className="popup-row-text2">
                    <p style={{ marginTop: "10px" }}>
                      Who do you want to see your course enrroled
                    </p>
                    <div className="popup-row-text2-container">
                      <div>
                        <input
        ...
        <div
          className="overlay1"
          style={isOpenVisible ? { display: "block" } : { display: "none" }}
          onClick={() => {
            setIsOpenVisible(false);
          }}
        ></div>
      ...
      <div className="personal-detail-container-row2">
        <div className="personal-detail-container-column2">
          ...
          <div
            className="popup-add-info"
            style={isOpenAddInfo ? { display: "block" } : { display: "none" }}
          >
            <div
              className="popup-add-info-buttonclose"
              onClick={() => {
            ...
            <div className="popup-row">
              ...
              <div className="popup3-row-title">
                <p>
                  Help employers get to know you better by adding other links
                  and describing what makes you a great candidate.
                </p>
              </div>
              ...
              <div className="popup3-row-title2">
                <p>
                  ...
                  portfolio? Add up to 4 links to make it easier for employers
                  to view your work.
                </p>
              </div>
              ...
              <div className="popup3-row-box">
                ...
                <div className="box">
                  ...
                  <div className="box-content3">
                    <button
                      onClick={() => handleRemoveClick("github")}
                      className="remove-button"
                    >
                      Remove
                    </button>
                ...
                <div className="box">
                  ...
                  <div className="box-content3">
                    <button
                      onClick={() => handleRemoveClick("linkedin")}
                      className="remove-button"
                    >
                      Remove
                    </button>
